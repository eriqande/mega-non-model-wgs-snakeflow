...
-   `resources`: downloaded and indexed genomes, etc.
...
1.  Remove the `results` and the `resources` directory, so that
    snakemake will run through the entire workflow, again:
