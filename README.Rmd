...
is set at 40, but should be larger (perhaps 100) for data sets with more
...
if not all, of the reads supporting that variant.  The default here is 9, but the effect
...
three `bqsr_*` config parameters listed above.  That is done by choosing the
